...
const BraakNode = new MyNode("Braak", [], (<div>
      <CitationCard citations={[Braak]}>
        <div>Table 1. Braak stages</div>
        <MyTable headers={headers} contents={rows}/>
        <Figure src="images/classification/transenthorinal_stage.png" alt="Transentorhinal stage" caption="Transenthorinal stage" n={1}/>
        <Figure src="images/classification/limbic_stage.png" alt="Limbic stage" caption="Entorhinal stage" n={2}/>
        <Figure src="images/classification/isocortical_stage.png" alt="Isocortical stage" caption="Hippocampal stage" n={3}/>
      </CitationCard>
    </div>));
