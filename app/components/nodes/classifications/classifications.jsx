...
const Classifications = new MyNode("Classifications", [], (<div>
      ...
      <CitationCard citations={[NIAAA]}>
        <Figure src="images/classifcation/classification.png" alt="Classification problem" caption="Interaction of ATN features" n={1}/>
        <Figure src="images/classifcation/atn_niaaa.png" alt="ATN X NIA-AA" caption="Biomarkers interactions with NIA-AA" n={2}/>
      </CitationCard>
      <CitationCard citations={[NIAAA]}>
      ...
      <Hypothesis>
        <Figure src="images/causality/causal_hypothesis.png" alt="Hypothesis" caption="The possible causalities of the biomarkers" n={1}/>
      </Hypothesis>
