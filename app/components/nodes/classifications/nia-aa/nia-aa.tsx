    ...
    (
        <div>
            <CitationCard citations={[bibtex.knopman2018national]}>
                The committee designed a 3-range system: normal (0),
                intermediate (1), and abnormal (2).
                <div>
                    Table 1. Syndromal staging of cognitive continuum:
                    Applicable to all members of a research cohort independent
                    from biomarker profiles
                </div>
                ...
                <Figure
                    src="images/classification/atn_niaaa.png"
                    alt="ATN X NIA-AA"
...
export const Wrapper = () => <>{NIAAANode.content}</>;
