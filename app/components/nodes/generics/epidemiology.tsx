...
import { ADBiologicalConstruct } from "@/public/citations";
import { frozza2018challenges } from "@/public/citations/bibtex.json";
...
export const Epidemiology = new MyNode(
  ...
  (
    <NodeCard>
      ...
      <CitationCard citations={[frozza2018challenges]}>
