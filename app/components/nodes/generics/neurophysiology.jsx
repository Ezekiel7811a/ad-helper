...
import { CombiningBrainSimAndMeg, SynergyABTauCorticalAndMC, XModel, } from "@/public/citations";
const Neurophysiology = new MyNode("Neurophysiology", [], (<div>
      <CitationCard citations={[CombiningBrainSimAndMeg]}>
        ...
        progresses.
        <Figure n={1} src="images/ab-tau/ab_tau_progression.png" alt="ab_tau_progression" caption="chematic representation of the spatiotemporal progression of Aβ and tau biomarker levels during AD progression."/>
      </CitationCard>
      <CitationCard citations={[SynergyABTauCorticalAndMC]}>
        ...
        the disease4,19.
        <Figure n={2} src="images/ab-tau/proposed_model_ad.png" alt="proposed_model" caption="the possible evolution of pathological changes across the AD continuum, with the new hypothesis of an early shift in neurophysiological activity from acceleration to slowing during the preclinical phase."/>
      ...
      <CitationCard citations={[XModel]}>
        ...
        <Figure n={3} src="images/hypersynchronization/x_model.png" alt="X model" caption="Proposition of a model explaining the observations made on sMCI."/>
      </CitationCard>
    </div>));
