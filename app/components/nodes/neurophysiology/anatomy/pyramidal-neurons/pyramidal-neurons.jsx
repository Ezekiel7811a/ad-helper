...
const PyramidalNeurons = new MyNode("PyramidalNeurons", [], (<div>
      <CitationCard citations={[EITranslationalPerspective]}>
        ...
        Farinas, 1992).
        <Figure src="images/neurons/pyramidal_degradation.png" alt="Pyramidal cell degradation" n={1} caption="Scheme representing the changes to pyramidal cell dendrites of that showed different patterns of PHF-tau immunostaining"/>
        <Figure src="images/ab-tau/ab_pyramidal.png" alt="AB pyramidal" n={2} caption="Aβ depositions on pyramidal cells"/>
      </CitationCard>
      <div>
