    ...
    (
        <NodeCard>
            <CitationCard citations={[bibtex.brunello2020mechanisms]}>
                ...
                that have an important function of regulating microtubules (MT)
                to ensure proper cytoskeletal organization and trafficking [1],
                which is particularly important in highly polarized neuronal
                cells whose functionality and viability depend on transport of
                cellular cargo to and from axonal and dendritic peripheries
                [2–4].
            </CitationCard>
            <CitationCard citations={[bibtex.brunello2020mechanisms]}>
                Tau has important physiological functions in regulating MT,
                including MT polymerization, stabilization and suppression of MT
                dynamics. Dysregulation of the tau–MT complex leads to tau
                detachment and instability and disassembly of MTs, eventually
                leading to perturbation of MT-dependent transport and impaired
                maintenance of cellular polarity and viability [4, 5].
            </CitationCard>
            <CitationCard citations={[bibtex.brunello2020mechanisms]}>
                The N-terminal projection domain consists of residues 1–150 (of
                the longest isoform) and it regulates microtubule binding.
                microtubule-binding repeat domains (MTBD). Splicing isoforms of
                tau contain either three (3R) or four (4R) MTBDs. The MTBDs, as
                the name suggests, interact with microtubules but also with
                actin, orchestrating the order and stability of the
                cytoskeleton.
            </CitationCard>
            <CitationCard citations={[bibtex.brunello2020mechanisms]}>
                Finally, several domains of the tau protein have the ability to
                interact with lipids and membranes [17], and one of tau kinases,
                Fyn, is mainly located in PM microdomains called lipid rafts,
                where tau can also be recruited [18]. It is also possible that
                tau localized at the PM occupies a role as a signaling
                regulator, via its interaction with membrane receptors [19, 20].
            </CitationCard>
            <CitationCard citations={[bibtex.brunello2020mechanisms]}>
                Tau is present in neurons and, to a lesser degree, in glial
                cells [6, 7]. Tau is mainly an axonal protein in mature neurons,
                but it can also be found in the nucleus, mitochondria,
                dendrites, synapses, and at the plasma membrane (PM) [8–13].
                This localization pattern suggests that besides the main
                function of MT regulation, tau may have other roles in cells.
            </CitationCard>
            <CitationCard citations={[bibtex.brunello2020mechanisms]}>
            ...
            hyperphosphorylated and forms neurofibrillary tangles. These tangles
            are associated with neuronal dysfunction and cell death. Tau
            pathology is thought to be a key driver of neurodegeneration in
            Alzheimer&apos;s disease.
            <CitationCard citations={[bibtex.frozza2018challenges]}>
                thereby destabilizing microtubules and compromising axonal
                transport (Querfurth and LaFerla, 2010; Ittner and Götz, 2011;
                Medeiros et al., 2011; Morris et al., 2011; Scheltens et al.,
                2016).
            </CitationCard>
            <CitationCard citations={[bibtex.brunello2020mechanisms]}>
                Tau is physiologically constantly phosphorylated and
                dephosphorylated to ensure regulation of proper functions, but
                when the balance is shifted toward phosphorylation, tau affinity
                for microtubules decreases [57]. This results in an increase in
                cytosolic tau, which becomes more vulnerable to aggregation
                [58].Additionally, abnormally phosphorylated tau is able to
                sequester other microtubule-associated proteins (MAP), further
                worsening microtubule destabilization [57].
            </CitationCard>
            <span>
                <CitationCard citations={[bibtex.brunello2020mechanisms]}>
                ...
                >
                    ...
                    leading to various tauopathies spanning from 352 to 441 aa
                </CitationCard>
                <CitationCard citations={[bibtex.levy202218f]}>
                    The characteristic tau pathology found in Alzheimer&apos;s
                    disease consists of neurofibrillary tangles (NFTs) composed
                    of all 6 tau isoforms.
                </CitationCard>
            </span>
            <CitationCard citations={[bibtex.busche2020synergy]}>
                The tau aggregates are commonly found in the medial temporal
                lobe, starting in the parahippocampal gyrus, which includes the
                entorhinal cortex, from which they spread to limbic areas, and
                from there to the association areas.
            </CitationCard>
