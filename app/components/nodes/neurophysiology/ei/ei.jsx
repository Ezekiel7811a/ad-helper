...
import { CombiningBrainSimAndMeg, InferringEIFromFieldPotentials, } from "@/public/citations";
import { MathJax } from "better-react-mathjax";
const EI = new MyNode("E/I balance", [], (<div>
      ...
      <CitationCard citations={[CombiningBrainSimAndMeg]}>
        ...
        <Figure src="images/ei/ei_balance.png" alt="ei_balance" caption="Spectral changes and E/I shifts in MCI. (A) Normalized power spectrum across all individuals from the control (Ctrl), MCIn,and MCIcv groups and over all ROIs." n={1}/>
      </CitationCard>
