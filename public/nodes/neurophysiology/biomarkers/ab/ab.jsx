...
import { EITranslationalPerspective, NeuroChemsOrganizationAd, SynergyABTauCorticalAndMC, } from "@/public/citations";
const AB = new MyNode("Amyloid Beta (AB)", [], (<div>
      ...
      <CitationCard citations={[EITranslationalPerspective]}>
        <Figure src="images/hypersynchronization/ab_hyperexcitation.png" alt="AB hyperexcitation model" n={1} caption="AB hyperexcitation model"/>
      </CitationCard>
      <div>
      ...
      <CitationCard citations={[EITranslationalPerspective]}>
        <Figure src="images/ab-tau/ab_pyramidal.png" alt="AB pyramidal" n={1} caption="Aβ depositions on pyramidal cells"/>
