...
const Frequencies = new MyNode("Frequencies", [], (<div>
      <CitationCard citations={[SynergyABTauCorticalAndMC]}>
        ...
        <Figure n={1} src="images/ab-tau/ab_frequencies.png" alt="ab_frequencies" caption="Interactive effects of AD proteinopathies on neurophysiological activity in asymptomatic adults"/>
